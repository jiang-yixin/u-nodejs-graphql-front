...
class Feed extends Component {
  ...
  componentDidMount() {
    ...
    fetch('http://localhost:8080/graphql', {
      ...
      .then(resData => {
        if (resData.errors) {
          throw new Error('Fetching user status is failed.');
        }
  ...
  loadPosts = direction => {
    ...
    fetch('http://localhost:8080/graphql', {
      ...
      .then(resData => {
        if (resData.errors) {
          throw new Error('Fetching post is failed.');
        }
        this.setState({
  ...
  finishEditHandler = postData => {
    ...
    fetch('http://localhost:8080/post-image', {
      ...
      .then(resData => {
        ...
        if (resData.errors) {
          throw new Error('Create post is failed.');
        }
        console.log(resData);
  ...
  deletePostHandler = postId => {
    ...
    fetch('http://localhost:8080/graphql', {
      ...
      .then(resData => {
        if (resData.errors) {
          throw new Error('Deleting the post is failed.');
        }
        console.log(resData);
        this.loadPosts();
        // this.setState(prevState => {
